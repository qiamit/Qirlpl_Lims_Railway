          ...
          <Table className="w-full table-fixed min-w-[1200px]">
            ...
            <TableHeader>
              <TableRow className="bg-muted/50">
                ...
                <TableHead className="text-left text-xs">IQC Master Standard</TableHead>
                ...
                <TableHead className="text-xs text-center">Cal Frequency</TableHead>
                <TableHead className="text-xs text-center">Last Cal Date</TableHead>
                <TableHead className="text-xs text-center">Next Due</TableHead>
