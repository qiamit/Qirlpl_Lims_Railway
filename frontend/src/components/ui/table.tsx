...
>(({ className, ...props }, ref) => (
  <div className="relative w-full max-w-full overflow-x-auto overflow-y-visible [-webkit-overflow-scrolling:touch]">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b border-[#e7e0d4] transition-colors hover:bg-[#f3e9d8] data-[state=selected]:bg-[#fde68a]/80',
      className,
    )}
    {...props}
  />
