...
export function RequireSampleAllocationAccess({
  ...
  if (!grantedByMatrix && !canAccessSampleAllocation(ctx)) {
    return (
      <AccessDeniedPage
        message="You do not have permission to access Sample Allocation. Ask the Laboratory Director to grant View or Edit access."
